...
import com.example.chate.adapters.UsersAdapter;
import com.example.chate.databinding.ActivityUsersBinding;
import com.example.chate.listeners.UserListener;
    ...
    private void getUsers(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    loading(false);
                    String currentUserId=prefenceManager.getString(Constants.KEY_USER_ID);
